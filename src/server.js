...
app.get(['/api/health','/api/v1/health'],(_req,res)=>res.json({ok:true,service:'NekoRoute',version:'0.4.2',nodes:pool.nodes.size}));
...
app.get('/api/v1',(_req,res)=>res.json({
  service:'NekoRoute',version:'0.4.2',docs:'/api/docs',openapi:'/api/openapi.json',endpoints:{
    ...
    test:'POST /api/v1/test',matrix:'POST /api/v1/test-matrix',scan:'POST /api/v1/scan',previewSession:'POST /api/v1/preview/session',previewResources:'GET /api/v1/preview/session/:id/resources',threatIntel:'GET /api/v1/threat-intel'
  }
}));
app.get('/api/openapi.json',(_req,res)=>res.json({openapi:'3.1.0',info:{title:'NekoRoute Public API',version:'0.4.2',description:'Regional availability diagnostics, defensive scanning, proxy-pool metadata and safe preview sessions.'},paths:{
