...
import { validateTarget, validatePublicTarget } from './security.js';
...
const allowedHosts = (process.env.ALLOWED_TEST_HOSTS || 'example.com').split(',').map(x => x.trim().toLowerCase()).filter(Boolean);
const config = {
